...
//        let bookingPlanVC = AcadamyBookingPlanViewController()
        let bookingPlanVC : AcadamyBookingPlanViewController = UIStoryboard(name: "main", bundle: nil).instantiateViewController(withIdentifier: "AcadamyBookingPlanViewController") as! AcadamyBookingPlanViewController
